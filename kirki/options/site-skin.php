...
DRY_CLEANING_Kirki::add_section( 'dt_site_skin_section', array(
	'title' => __( 'Site Skin', 'dry-cleaning' ),
	'priority' => 23
) );
	...
	DRY_CLEANING_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Predefined Skin ?', 'dry-cleaning' ),
	...
	DRY_CLEANING_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Skin', 'dry-cleaning' ),
		'section'  => 'dt_site_skin_section',
		'default' => dry_cleaning_defaults('predefined-skin' ),
		'multiple' => 1,
		'priority' => 2,
		...
		'choices' => array(
			'blue'			=>	esc_attr__('Blue','dry-cleaning'),			'brown'			=>	esc_attr__('Brown','dry-cleaning'),
			'cadetblue'		=>	esc_attr__('Cadet Blue','dry-cleaning'),	'chilipepper'	=>	esc_attr__('Chili Pepper','dry-cleaning'),
			'cyan'			=>	esc_attr__('Cyan','dry-cleaning'),			'deeporange'	=>	esc_attr__('Deep Orange','dry-cleaning'),	
			'deeppurple'	=>	esc_attr__('Deep Purple','dry-cleaning'),
			'green'			=>	esc_attr__('Green','dry-cleaning'),			'lime'			=>	esc_attr__('Lime','dry-cleaning'),
			'magenta'		=>	esc_attr__('Magenta','dry-cleaning'),		'orange'		=>	esc_attr__('Orange','dry-cleaning'),
			'pink'			=>	esc_attr__('Pink','dry-cleaning'),			'purple'		=>	esc_attr__('Purple','dry-cleaning'),
			'red'			=>	esc_attr__('Red','dry-cleaning'),			'skyblue'		=>	esc_attr__('Sky Blue','dry-cleaning'),
			'teal'			=>	esc_attr__('Teal','dry-cleaning'),			'turquoise'		=>	esc_attr__('Turquoise','dry-cleaning'),
			'wisteria'		=>	esc_attr__('Wisteria','dry-cleaning'),		'yellow'		=>	esc_attr__('Yellow','dry-cleaning'),
		)
	));
	...
	DRY_CLEANING_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Primary Color', 'dry-cleaning' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 3,
		'choices' => array( 'alpha' => true ),
		'default'  => dry_cleaning_defaults('primary-color'),
		'active_callback' => array(
		...
		'output' => array(
			...
			array( 'element' => '.top-bar a:hover, .menu-icons-wrapper .search a:hover, .menu-icons-wrapper .cart a:hover, .breadcrumb a:hover', 'property' => 'color' ),
			...
			array( 'element' => '#footer a:hover, #footer .footer-copyright .menu-links li a:hover, #footer .footer-copyright .copyright-left a:hover, #footer .dt-sc-dark-bg .recent-posts-widget li .entry-meta a:hover, #footer .dt-sc-dark-bg .entry-title h4 a:hover, #footer .dt-sc-dark-bg a:hover, .left-header-footer .dt-sc-sociable.filled li a', 'property' => 'color' ),

			# Primary Color - Portfolio	
			array( 'element' => '.portfolio .image-overlay .links a:hover, .portfolio.type7 .image-overlay .links a, .project-details li a:hover, .portfolio-categories a:hover, .dt-portfolio-single-slider-wrapper #bx-pager a.active:hover:before, .dt-portfolio-single-slider-wrapper #bx-pager a', 'property' => 'color' ),
			...
			array( 'element' => '.dt-sc-testimonial.type4 .dt-sc-testimonial-author cite, .dt-sc-testimonial.type5 .dt-sc-testimonial-author cite, .dt-sc-testimonial.type7 .dt-sc-testimonial-quote blockquote cite, .dt-sc-testimonial.type8 .dt-sc-testimonial-quote blockquote q:before, .dt-sc-testimonial.type8 .dt-sc-testimonial-quote blockquote q:after, .dt-sc-testimonial-special-wrapper:after', 'property' => 'color' ),
			...
			array( 'element' => '.dt-sc-image-with-caption h3 a, .dt-sc-image-caption.type3 .dt-sc-image-content h3, .dt-sc-event-image-caption .dt-sc-image-content h3, .dt-sc-image-caption.type8:hover .dt-sc-image-content h3 a:hover', 'property' => 'color' ),
			...
			array( 'element' => '.dt-sc-sociable.diamond-square-border li:hover a, .dt-sc-sociable.hexagon-border li:hover a, .dt-sc-sociable.hexagon-with-border li:hover a', 'property' => 'color' ),
			...
			array( 'element' => '.dt-sc-menu-sorting a:hover, .dt-sc-menu-sorting a.active-sort, .dt-sc-training-details h6, .dt-sc-fitness-diet:hover .dt-sc-fitness-diet-details h5, table.fit-Diet-table th strong, .dt-sc-hotel-room-single-metadata ul li, .dt-sc-hotel-room .dt-sc-hotel-room-details ul li', 'property' => 'color' ),
...
.menu-icons-wrapper.rounded-icons .search a span:hover, .menu-icons-wrapper.rounded-icons .cart a span:hover, .menu-icons-wrapper .cart sup', 'property' => 'background-color' ),
			...
			array( 'element' => 'ul.side-nav li a:hover:before, ul.side-nav > li.current_page_item > a:before, ul.side-nav > li > ul > li.current_page_item > a:before, ul.side-nav > li > ul > li > ul > li.current_page_item > a:before, .dt-sc-small-separator, .dt-sc-diamond-separator, .dt-sc-titled-box h6.dt-sc-titled-box-title, .carousel-arrows a:hover, .dt-sc-images-wrapper .carousel-arrows a:hover, .diamond-narrow-square-border li:hover:before, .dt-sc-sociable.hexagon-with-border li, .dt-sc-skin-highlight, .dt-sc-skin-highlight.extend-bg-fullwidth-left:after, .dt-sc-skin-highlight.extend-bg-fullwidth-right:after, .two-color-section:before, .dt-sc-readmore-plus-icon:hover:before, .dt-sc-readmore-plus-icon:hover:after, .dt-sc-contact-details-on-map .map-switch-icon, .dt-sc-content-with-hexagon-shape, .dt-sc-hexagons li .dt-sc-hexagon-overlay, .available-domains li .tdl:before, .available-domains li:hover .dt-sc-button, .domain-search-container .domain-search-form', 'property' => 'background-color' ),
			...
			array( 'element' => '.live-chat a, .dt-bmi-inner-content tbody th, .dt-bmi-inner-content tbody tr:nth-child(2n+1) th, .dt-sc-menu .menu-categories a:before, .hotel-search-container form input[type="submit"]:hover, .hotel-search-container .selection-box:after, .dt-sc-training-details-overlay', 'property' => 'background-color' ),
			...
			array( 'element' => '.dt-sc-testimonial.type5 .dt-sc-testimonial-quote, .dt-sc-testimonial-images li.selected div, .dt-sc-testimonial-wrapper .dt-sc-testimonial-bullets a:hover, .dt-sc-testimonial-wrapper .dt-sc-testimonial-bullets a.active, .dt-sc-testimonial-wrapper .dt-sc-testimonial-bullets a.active:before, .dt-sc-testimonial-wrapper .dt-sc-testimonial-bullets a.active:hover:before, ', 'property' => 'border-color' ),
			...
			array( 'element' => '.dt-sc-icon-box.type5.no-icon .icon-content h4, .dt-sc-icon-box.type5.no-icon, .dt-sc-icon-box.type10, .dt-sc-icon-box.type10 .icon-wrapper:before, .dt-sc-icon-box.type3.dt-sc-diamond:hover .icon-wrapper:after', 'property' => 'border-color' ),

			# Primary Border Color - Image Caption
			array( 'element' => '.dt-sc-image-caption.type2 .dt-sc-image-content, .dt-sc-image-caption.type4, .dt-sc-image-caption.type4:hover .dt-sc-button', 'property' => 'border-color' ),

			# Primary Border Color - Miscellaneous/Shortcodes
			array( 'element' => '.dt-sc-title.with-right-border-decor h2:before, .dt-sc-pr-tb-col.type2 .dt-sc-tb-header:before, .dt-sc-newsletter-section.type2 .dt-sc-subscribe-frm input[type="text"], .dt-sc-text-with-icon.border-bottom, .dt-sc-text-with-icon.border-right, .dt-sc-hexagons li:hover, .dt-sc-hexagons li:hover:before, .dt-sc-hexagons li:hover:after, .dt-sc-hexagons li, .dt-sc-hexagons li:before, .dt-sc-hexagons li .dt-sc-hexagon-overlay:before, .dt-sc-hexagons li:after, .dt-sc-hexagons li .dt-sc-hexagon-overlay:after, .dt-sc-single-hexagon, .dt-sc-single-hexagon:before, .dt-sc-single-hexagon .dt-sc-single-hexagon-overlay:before, .dt-sc-single-hexagon:after, .dt-sc-single-hexagon .dt-sc-single-hexagon-overlay:after, .dt-sc-single-hexagon:hover, .dt-sc-single-hexagon:hover:before, .dt-sc-single-hexagon:hover:after, .carousel-arrows a:hover, .vc_custom_carousel .slick-slider .slick-dots, .vc_custom_carousel .slick-slider:before', 'property' => 'border-color' ),

			# Primary Border Top Color - Miscellaneous/Shortcodes
			array( 'element' => '.dt-sc-triangle-wrapper:hover .dt-sc-triangle-content:before, .dt-sc-pr-tb-col.type2 .dt-sc-tb-content:after, .dt-sc-content-with-hexagon-shape:after, .type7 ul.dt-sc-tabs-horizontal-frame > li > a.current:before, .type7 ul.dt-sc-tabs-horizontal-frame > li > a.current:after, .skin-highlight .dt-sc-tabs-horizontal-frame-container.type6 ul.dt-sc-tabs-horizontal-frame > li > a:before', 'property' => 'border-top-color' ),
	...
	DRY_CLEANING_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Secondary Color', 'dry-cleaning' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 4,
		'choices' => array( 'alpha' => true ),
		'default'  => dry_cleaning_defaults('secondary-color'),
		'active_callback' => array(
			array( 'setting' => 'use-predefined-skin', 'operator' => '==', 'value' => '0' )
		),
		'output' => array(
	...
	DRY_CLEANING_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Tertiary Color', 'dry-cleaning' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 5,
		'choices' => array( 'alpha' => true ),
		'default'  => dry_cleaning_defaults('tertiary-color'),
		'active_callback' => array(
			array( 'setting' => 'use-predefined-skin', 'operator' => '==', 'value' => '0' )
		),
		'output' => array(
	...
	DRY_CLEANING_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Site BG Color', 'dry-cleaning' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
			array( 'element' => '
		...
		'choices' => array( 'alpha' => true ),
		'default'  => dry_cleaning_defaults('body-bg-color'),
	));
	...
	DRY_CLEANING_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Site Content Color', 'dry-cleaning' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
			array( 'element' => 'body' , 'property' => 'color' )
		),
		'choices' => array( 'alpha' => true ),
		'default'  => dry_cleaning_defaults('body-content-color'),
	));
	...
	DRY_CLEANING_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Site Link Color', 'dry-cleaning' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
			array( 'element' => 'a' , 'property' => 'color' )
		),
		'choices' => array( 'alpha' => true ),
		'default'  => dry_cleaning_defaults('body-a-color'),
	));
	...
	DRY_CLEANING_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Site Link Hover Color', 'dry-cleaning' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
			array( 'element' => 'a:hover' , 'property' => 'color' )
		),
		'choices' => array( 'alpha' => true ),
		'default'  => dry_cleaning_defaults('body-a-hover-color'),
	));					