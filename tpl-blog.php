...
get_header();
    ...
    <section id="primary" class="<?php echo esc_attr( $page_layout );?>"><?php
                        ...
                        <?php if( $post_style == "entry-date-left"): ?>
                                ...
                                <div class="entry-details">
                                	...
                                	<div class="entry-title">
                                    	<h4><a href="<?php the_permalink();?>" title="<?php printf(esc_attr__('Permalink to %s','dry-cleaning'), the_title_attribute('echo=0'));?>"><?php the_title(); ?></a></h4>
                                    </div>
                                    ...
                                    <?php if( array_key_exists('blog-post-excerpt',$tpl_default_settings) && array_key_exists('blog-post-excerpt-length',$tpl_default_settings) ):?>
                                    		<div class="entry-body"><?php echo dry_cleaning_excerpt($tpl_default_settings['blog-post-excerpt-length']);?></div>
                                   <?php endif;?>
						...
						<?php else: # Default Post Style ?>
                        		<div class="entry-details">
                                    ...
                                    <div class="entry-meta <?php echo esc_attr($tclass);?>">
                                    	...
                                    	<div class="date <?php echo esc_attr($show_date_meta);?>"><?php esc_html_e('Posted on','dry-cleaning'); echo get_the_date(' d M Y');?></div>
        ...
        <!-- **Pagination** -->
        <div class="pagination blog-pagination"><?php echo dry_cleaning_pagination($the_query); ?></div><!-- **Pagination** -->
        <!-- Blog Template Ends -->
