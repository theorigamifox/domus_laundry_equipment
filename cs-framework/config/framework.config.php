...
$options[]   = array(
  ...
  'fields'   => array(
    ...
    array(
      'type'    => 'notice',
      'class'   => 'info',
      'content' => 'Also you can add your own validate from <strong>dry-cleaning/cs-framework/functions/validate.php</strong>',
    ),
...
$options[]   = array(
  ...
  'fields'   => array(
    ...
    array(
      'type'    => 'notice',
      'class'   => 'info',
      'content' => 'Custom Sanitize, Also you can add your own validate from <strong>dry-cleaning/cs-framework/functions/sanitize.php</strong>',
    ),
